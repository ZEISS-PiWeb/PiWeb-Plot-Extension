...
declare module "piweb/expressions" {
	 ...
	 * @private
	 */
	export function readExpressionValue(reader: BufferReader): ExpressionDataType;
}
...
declare module "piweb/properties" {
	...
	*/ /** */
	...
	import { ExpressionDataArray, ExpressionDataType } from 'piweb/expressions';
	/**
	...
	/**
	 * Returns the evaluated value of the formula property with the name `id`.
	 * @param id The name of the property.
	 * @host
	 * @version 1.6
	 */
	export function getFormulaProperty(id: string): ExpressionDataType;
	/**
	 * Returns the evaluated value of the formula property with the name `id` as string.
	 * @param id The name of the property.
	 * @host
	 * @version 1.6
	 */
	export function getFormulaPropertyAsString(expression: string): string | undefined;
	/**
	 * Returns the evaluated value of the formula property with the name `id` as number.
	 * @param id The name of the property.
	 * @host
	 * @version 1.6
	 */
	export function getFormulaPropertyAsNumber(expression: string): number | undefined;
	/**
	 * Returns the evaluated value of the formula property with the name `id` as date.
	 * @param id The name of the property.
	 * @host
	 * @version 1.6
	 */
	export function getFormulaPropertyAsDate(expression: string): Date | undefined;
	/**
	 * Returns the evaluated value of the formula property with the name `id` as array.
	 * @param id The name of the property.
	 * @host
	 * @version 1.6
	 */
	export function getFormulaPropertyAsArray(expression: string): ExpressionDataArray | undefined;
}
...
declare module "piweb/data/defect" {
	...
	import { PlotTolerance } from 'piweb/data/plot/tolerance';
	import { PlotPropertyCollection } from 'piweb/data/plot/property';
	import { InspectionPlanItem } from 'piweb/data/inspection';
	import { ElementSystem } from 'piweb/data/plot/geometry';
	/**
...
declare module "piweb/data" {
	...
	*/
	 ...
	 * @private
	 */
	export { Vector } from "piweb/data/plot/vector";
	/**
	 * @private
	 */
	export { PlotTolerance, LinearPlotTolerance, RadialPlotTolerance, RectangularPlotTolerance, SpatialPlotTolerance, PlotToleranceType } from "piweb/data/plot/tolerance";
	/**
	 * @private
	 */
	export { PlotProperty, PlotPropertyType, PlotPropertyCollection } from "piweb/data/plot/property";
	/**
	 * @private
	 */
	export { PlotGeometry, PlotGeometryType, PlotDeviationType, ElementSystem, CircleInProfilePlotGeometry, CirclePlotGeometry, CylinderPlotGeometry, LinePlotGeometry, PitchPlotGeometry, PlanePlotGeometry } from "piweb/data/plot/geometry";
	/**
	 * @private
	 */
	export { Segment, SegmentType } from "piweb/data/plot/segment";
	/**
	* @private
	*/
	export { PlotPoint, PlotPointState, CurvePlotPoint } from "piweb/data/plot/point";
	/**
	 * @private
	 */
	export { Formplot, FormplotType, getFormplotCollection } from "piweb/data/plot";
	/**
	 * @private
	 */
...
declare module "piweb/data/plot" {
	...
	import { MeasurementValue, Measurement } from "piweb/data/measurements";
	import { InspectionPlanItem } from 'piweb/data/inspection';
	import { PlotGeometry } from 'piweb/data/plot/geometry';
	import { PlotTolerance } from 'piweb/data/plot/tolerance';
	import { PlotPropertyCollection } from 'piweb/data/plot/property';
	import { Segment } from 'piweb/data/plot/segment';
	/**
	 * Known types of plot geometries, usually used for different plot types.
	 */
	export type FormplotType = "none" | "circle" | "plane" | "curve" | "line" | "cylinder" | "pitch" | "borePattern" | "circleInProfile" | "fourier";
	/**
	  * @private
	  */
	export const enum FormplotTypeId {
	    None = 0,
	    Circle = 1,
	    Plane = 2,
	    Curve = 3,
	...
	/**
	 * Represents a formplot. The plot type can be determined from the [[Formplot.type]] property. Depending on the type,
	 * the plot contains different point formats and geometry information.
	 * @version 1.4
	 */
	export class Formplot {
	    constructor(type: FormplotType, measurementId: string | undefined, characteristicId: string | undefined, nominal: PlotGeometry, actual: PlotGeometry, tolerance: PlotTolerance | undefined, properties: PlotPropertyCollection, segments: Iterable<Segment>);
	    /**
	     * The formplot type.
	     */
	    type: FormplotType;
	 ...
	 * @version 1.4
	 */
	export class FormplotCollection implements Iterable<Formplot> {
	    /**
	     * @private
	     */
	    private readonly _measurementIdMap;
	     ...
	     * @private
	     */
	    constructor(plots: ReadonlyArray<Formplot>);
	    /**
	     * @private
	     */
	    [Symbol.iterator](): Iterator<Formplot>;
	    /**
	     ...
	     * @param entity A measurement, measurement value or inspection plan item.
	     */
	    findPlotsByEntity(entity: Measurement | MeasurementValue | InspectionPlanItem): Iter<Formplot>;
	    /**
	     * @private
	     */
	    first(): Formplot | undefined;
	}
	/**
	 ...
	 * @host
	 */
	export function getFormplotCollection(): FormplotCollection;
}
...
declare module "piweb/data/plot/geometry" {
	 ...
	 * Known types of plot geometries, usually used for different plot types.
	 */
	export type PlotGeometryType = "none" | "circle" | "circleInProfile" | "curve" | "cylinder" | "line" | "pitch" | "plane";
	/**
	  * @private
	  */
	export const enum PlotGeometryTypeId {
	    None = 0,
	    Circle = 1,
	    CircleInProfile = 2,
	    Curve = 3,
	 ...
	 */
	export type PlotDeviationType = "none" | "length" | "angle";
	/**
	  * @private
	  */
	export const enum PlotDeviationTypeId {
	    None = 0,
	    Length = 1,
	    Angle = 2,
	}
	...
	/**
	 * Base class for formplot geometries.
	 */
	export class PlotGeometry {
	    constructor(type: PlotGeometryType, elementSystem: ElementSystem);
	    /**
	     * The geometry type.
	     */
	    type: PlotGeometryType;
	    /**
	     * The 4x3 transformation matrix of this plot.
	     */
	    elementSystem: ElementSystem;
	}
	/**
	 * Geometry for circle plots.
	 */
	export class CirclePlotGeometry extends PlotGeometry {
	    constructor(elementSystem: ElementSystem, radius: number);
	    /**
	...
	/**
	 * Geometry for cylinder plots.
	 */
	export class CylinderPlotGeometry extends PlotGeometry {
	    constructor(elementSystem: ElementSystem, radius: number, height: number);
	    /**
	 ...
	 * Geometry for circle plots.
	 */
	export class CircleInProfilePlotGeometry extends CirclePlotGeometry {
	    constructor(elementSystem: ElementSystem, radius: number, firstTouchingPoint: Vector, secondTouchingPoint: Vector, maxGapPoint: Vector);
	    /**
	     * The first touching point of the circle with the profile.
	     */
	    firstTouchingPoint: Vector;
	    /**
	    * The second touching point of the circle with the profile.
	    */
	    secondTouchingPoint: Vector;
	    /**
	    * The point on the circle which has the maximum distance from the profile.
	    */
	    maxGapPoint: Vector;
	}
	/**
	 * Geometry for line plots.
	 */
	export class LinePlotGeometry extends PlotGeometry {
	    constructor(elementSystem: ElementSystem, position: Vector, direction: Vector, deviation: Vector, length: number);
	    /**
	...
	/**
	 * Geometry for pitch plots.
	 */
	export class PitchPlotGeometry extends PlotGeometry {
	    constructor(elementSystem: ElementSystem, deviationType: PlotDeviationType);
	    /**
	     * The deviation type of the plot.
	     */
	    deviationType: PlotDeviationType;
	}
	/**
	 * Geometry for plane plots.
	 */
	export class PlanePlotGeometry extends PlotGeometry {
	    constructor(elementSystem: ElementSystem, length1: number, length2: number);
	    /**
	 ...
	 * @private
	 */
	export function readGeometry(source: BufferReader): PlotGeometry;
}
...
declare module "piweb/data/plot/point" {
	 ...
	 * @version 1.4
	 */
	export const enum PlotPointState {
	    /**
	    * No state.
	    */
	    None = 0,
	...
	/**
	 * Base class for formplot points.
	 * @version 1.4
	 */
	export abstract class PlotPoint {
	    constructor(tolerance: PlotTolerance | undefined, properties: PlotPropertyCollection, state: PlotPointState);
	    /**
	 ...
	 * @version 1.4
	 */
	export class CurvePlotPoint extends PlotPoint {
	    /**
	     * @private
	     */
	    constructor(tolerance: PlotTolerance | undefined, properties: PlotPropertyCollection, state: PlotPointState, position: Vector, direction: Vector, deviation: number);
	    /**
	 ...
	 * @version 1.4
	 */
	export class CirclePlotPoint extends PlotPoint {
	    /**
	     * @private
	     */
	    constructor(tolerance: PlotTolerance | undefined, properties: PlotPropertyCollection, state: PlotPointState, angle: number, deviation: number);
	    /**
	...
	/**
	 * Represents a point in a cylinder plot.
	 * @version 1.4
	 */
	export class CylinderPlotPoint extends PlotPoint {
	    /**
	     * @private
	     */
	    constructor(tolerance: PlotTolerance | undefined, properties: PlotPropertyCollection, state: PlotPointState, angle: number, height: number, deviation: number);
	    /**
	     * Angle of the point in radians.
	     */
	    angle: number;
	    /**
	     * Height of the point on the cylinder.
	     */
	    height: number;
	    /**
	     * Deviation.
	 ...
	 * @version 1.4
	 */
	export class FourierPlotPoint extends PlotPoint {
	    /**
	     * @private
	     */
	    constructor(tolerance: PlotTolerance | undefined, properties: PlotPropertyCollection, state: PlotPointState, harmonic: number, amplitude: number);
	    /**
	     * Harmonic component.
	     */
	    harmonic: number;
	...
	/**
	 * Represents a point in a line plot.
	 * @version 1.4
	 */
	export class LinePlotPoint extends PlotPoint {
	    /**
	     * @private
	     */
	    constructor(tolerance: PlotTolerance | undefined, properties: PlotPropertyCollection, state: PlotPointState, position: number, deviation: number);
	    /**
	     * Position relative to the position of the `geometry`.
	     */
	    position: number;
	    /**
	     * Deviation.
	 ...
	 * @version 1.4
	 */
	export class PitchPlotPoint extends PlotPoint {
	    /**
	     * @private
	     */
	    constructor(tolerance: PlotTolerance | undefined, properties: PlotPropertyCollection, state: PlotPointState, position: number, deviation: number);
	 ...
	 * @version 1.4
	 */
	export class PlanePlotPoint extends PlotPoint {
	    /**
	     * @private
	     */
	    constructor(tolerance: PlotTolerance | undefined, properties: PlotPropertyCollection, state: PlotPointState, coordinate1: number, coordinate2: number, deviation: number);
	    /**
	 ...
	 * @private
	 */
	export function readPoint(source: BufferReader, type: FormplotTypeId): PlotPoint;
}
...
declare module "piweb/data/plot/property" {
	...
	export class PlotPropertyCollection {
	     ...
	     * @private
	     */
	    static readonly empty: PlotPropertyCollection;
	    /**
	     * @private
	     */
...
declare module "piweb/data/plot/segment" {
	...
	import { Iter } from 'iter';
	import { FormplotTypeId } from 'piweb/data/plot';
	import { PlotPoint } from 'piweb/data/plot/point';
	/**
	 * Known segment types that indicate the supposed usage of a segment.
	 * @version 1.4
	 */
	export type SegmentType = "none" | "circle" | "line" | "helix" | "touchingPoint" | "maxGapPoint" | "bendingCircle" | "axis" | "nominalReferenceProfile" | "nominalMeasureProfile" | "actualReferenceProfile" | "actualMeasureProfile" | "nominalProfile" | "actualProfile";
	/**
	* @private
	*/
	export const enum SegmentTypeId {
	    None = 0,
	    Circle = 1,
	    Line = 2,
	    Helix = 3,
	    ...
	    BendingCircle = 6,
	    Axis = 7,
	    NominalReferenceProfile = 8,
	    NominalMeasureProfile = 9,
	    ActualReferenceProfile = 10,
	    ActualMeasureProfile = 11,
	    NominalProfile = 12,
	    ActualProfile = 13,
	}
	/**
	...
	export class Segment {
	     ...
	     * @private
	     */
	    constructor(name: string, type: SegmentType, points: Iterable<PlotPoint>);
	    /**
	 ...
	 * @private
	 */
	export function readSegment(source: BufferReader, type: FormplotTypeId): Segment;
}
...
declare module "piweb/drawing" {
	 ...
	 * the plot extension API will emit the `render` event, which has a [[DrawingContext]] object as its parameter.
	 *
	 * ```TypeScript
	 * import * as piweb from 'piweb';
...
declare module "piweb/drawing/material/brushes" {
	...
	export class RadialGradientBrush extends Brush implements RadialBrushDescription {
	    ...
	    /**
	     * @version 1.7
	     * Gets or sets the radius relative to the target area size.
	     */
	    radius: number;
	    /**
	     * @private
	     ...
	     * @param radius
	     */
	    constructor(color1: Color, color2: Color, center: Point, opacity: number, radius?: number);
	    /**
