...
<pre><code class="language-javascript">&gt; semver.inc(<span class="hljs-string">'1.2.3'</span>, <span class="hljs-string">'pre'</span>, <span class="hljs-string">'beta'</span>)
<span class="hljs-string">'1.2.4-beta.0'</span>
</code></pre>
<p>command-line example:</p>
<pre><code class="language-shell"><span class="hljs-meta">$</span><span class="bash"> semver 1.2.3 -i prerelease --preid beta</span>
1.2.4-beta.0
</code></pre>
<p>Which then can be used to increment further:</p>
<pre><code class="language-shell"><span class="hljs-meta">$</span><span class="bash"> semver 1.2.4-beta.0 -i prerelease</span>
1.2.4-beta.1
</code></pre>
