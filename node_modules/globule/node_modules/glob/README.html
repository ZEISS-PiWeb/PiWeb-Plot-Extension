...
<h2>Usage</h2>
<pre><code class="language-javascript"><span class="hljs-keyword">var</span> glob = <span class="hljs-built_in">require</span>(<span class="hljs-string">"glob"</span>)
...
<pre><code class="language-javascript"><span class="hljs-keyword">var</span> Glob = <span class="hljs-built_in">require</span>(<span class="hljs-string">"glob"</span>).Glob
