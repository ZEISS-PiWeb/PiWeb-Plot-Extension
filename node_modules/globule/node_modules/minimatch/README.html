...
objects.</p>
<h2>Usage</h2>
<pre><code class="language-javascript"><span class="hljs-keyword">var</span> minimatch = <span class="hljs-built_in">require</span>(<span class="hljs-string">"minimatch"</span>)
...
<pre><code class="language-javascript"><span class="hljs-keyword">var</span> Minimatch = <span class="hljs-built_in">require</span>(<span class="hljs-string">"minimatch"</span>).Minimatch
...
<pre><code class="language-javascript"><span class="hljs-keyword">var</span> isJS = minimatch(file, <span class="hljs-string">"*.js"</span>, { <span class="hljs-attr">matchBase</span>: <span class="hljs-literal">true</span> })
</code></pre>
...
<pre><code class="language-javascript"><span class="hljs-keyword">var</span> javascripts = fileList.filter(minimatch.filter(<span class="hljs-string">"*.js"</span>, {<span class="hljs-attr">matchBase</span>: <span class="hljs-literal">true</span>}))
</code></pre>
...
<pre><code class="language-javascript"><span class="hljs-keyword">var</span> javascripts = minimatch.match(fileList, <span class="hljs-string">"*.js"</span>, {<span class="hljs-attr">matchBase</span>: <span class="hljs-literal">true</span>}))
</code></pre>
