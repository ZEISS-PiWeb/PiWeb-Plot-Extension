...
<pre><code class="language-js"><span class="hljs-keyword">var</span> kindOf = <span class="hljs-built_in">require</span>(<span class="hljs-string">'kind-of'</span>);
...
<pre><code class="language-bash"><span class="hljs-comment">#1: array</span>
