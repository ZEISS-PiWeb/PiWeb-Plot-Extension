...
<h2>Usage</h2>
<pre><code class="language-js"><span class="hljs-keyword">var</span> ansi = <span class="hljs-built_in">require</span>(<span class="hljs-string">'ansi-styles'</span>);
...
<h6>Example</h6>
<pre><code class="language-js"><span class="hljs-built_in">console</span>.log(ansi.colors.green.open);
</code></pre>
<h2>License</h2>
