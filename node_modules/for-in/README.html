...
<pre><code class="language-sh">$ npm install --save <span class="hljs-keyword">for</span>-in
</code></pre>
<h2>Usage</h2>
<pre><code class="language-js"><span class="hljs-keyword">var</span> forIn = <span class="hljs-built_in">require</span>(<span class="hljs-string">'for-in'</span>);
...
<pre><code class="language-sh">$ npm install -g verbose/verb<span class="hljs-comment">#dev verb-generate-readme &amp;&amp; verb</span>
</code></pre>
<h3>Running tests</h3>
...
<pre><code class="language-sh">$ npm install &amp;&amp; npm <span class="hljs-built_in">test</span>
</code></pre>
<h3>Author</h3>
