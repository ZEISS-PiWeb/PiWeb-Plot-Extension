...
<pre><code class="language-js">gulp.src(<span class="hljs-string">'lib/*.js'</span>)
  .pipe(uglify())
  .pipe(gulp.src(<span class="hljs-string">'styles/*.css'</span>))
  .pipe(gulp.dest(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">file</span>)</span>{
    <span class="hljs-comment">// I don't know, you can do something cool here</span>
    <span class="hljs-keyword">return</span> <span class="hljs-string">'build/whatever'</span>;
  }));
</code></pre>
<h2>3.7.0</h2>
<ul>
