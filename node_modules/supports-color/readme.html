...
<h2>Usage</h2>
<pre><code class="language-js"><span class="hljs-keyword">var</span> supportsColor = <span class="hljs-built_in">require</span>(<span class="hljs-string">'supports-color'</span>);
